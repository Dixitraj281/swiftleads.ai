            ...
            <div className="col-lg-12">
              <div className="inner text-center mt--140">
                ...
                <p className="description">
                  Empower Your Agents <br />{" "}
                  Elevate Client Experience with AI
                </p>
                <div className="form-group">
                  <textarea
                    ...
                    cols="30"
                    rows="2"
                    placeholder="Enter a prompt, for example: The buying/selling process, and mortgage options."
                  ></textarea>
            ...
            <div className="col-lg-12">
              ...
              >
                <h4 className="subtitle">
                  ...
                  Unlock Faster Leads, with Our AI Solution
                  </span>
                </h4>
                <h2 className="title mb--0">
                Smarter way to connect <br /> streamline the real estate journey.
                </h2>
              </div>
            </div>
          </div>
